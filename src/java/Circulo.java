...
@WebServlet(urlPatterns = {"/Circulo"})
public class Circulo extends HttpServlet {
    
    static String URL_CIRC = "<img src=\"img/circulo.png\" width=20% class=\"center\">";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println();
              out.println(imagem);  
            out.println("<p>A <span style=\"color:#FF7F27\">Área</span> do " + forma + " com raio " + formater.format(a) + " é de: " + formater.format(area) + " cm.</p>");
            out.println("<p>O <span style=\"color:#ED1C24\">Perimetro</span> do " + forma + " com raio " + formater.format(a) + " é de: " + formater.format(p) + " cm.</p>");
