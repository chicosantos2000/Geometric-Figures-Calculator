...
@WebServlet(urlPatterns = {"/Retangulo"})
public class Retangulo extends HttpServlet {
    
    static String URL_RETANGULO = "<img src=\"img/retangulo.png\" width=20%>";
