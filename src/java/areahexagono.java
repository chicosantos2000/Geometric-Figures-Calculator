...
@WebServlet(urlPatterns = {"/areahexagono"})
public class areahexagono extends HttpServlet {
    
    static String URL_HEXAGONO = "<img src=\"img/Hexagono.png\" width=20%>";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String forma = "Hexagono";
        String imagem = URL_HEXAGONO;
