...
@WebServlet(urlPatterns = {"/arealosangulo"})
public class arealosangulo extends HttpServlet {
    
    static String URL_LOSANGULO = "<img src=\"img/losango.png\" width=20%>";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String forma = "Losangulo";
        String imagem = URL_LOSANGULO;
        ...
        try (PrintWriter out = response.getWriter())  {
            ...
            out.println();
            out.println(imagem);  
            out.println("<p>A <span style=\"color:#FF7F27\">Área</span> do " + forma + " com lado " + formater.format(a) + " é de: " + formater.format(area) + " cm.</p>");
