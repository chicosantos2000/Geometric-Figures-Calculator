...
@WebServlet(urlPatterns = {"/areaquadrado"})
public class areaquadrado extends HttpServlet {
    
    static String URL_QUADRADO = "<img src=\"img/quadrado.png\" width=20%>";
