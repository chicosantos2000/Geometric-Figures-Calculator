...
@WebServlet(urlPatterns = {"/perimetroquadrado"})
public class perimetroquadrado extends HttpServlet {
    
    static String URL_QUADRADO = "<img src=\"img/quadrado.jpg\" width=20%>";
